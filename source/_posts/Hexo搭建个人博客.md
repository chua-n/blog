...
![](https://chua-n.gitee.io/blog-images/hexo搭博客/hexo-default.jpeg)
...
效果如下：
![](https://chua-n.gitee.io/blog-images/hexo搭博客/hexo-written.jpeg)
...
![](https://chua-n.gitee.io/blog-images/hexo搭博客/next.jpeg)
...
-   新建一篇文章进行测试：
    ...
    效果如下：![](https://chua-n.gitee.io/blog-images/hexo搭博客/test-math.png)
...
并在 Gitee Pages 仓库中重新部署 Pages 服务：![](https://chua-n.gitee.io/blog-images/hexo搭博客/update-gitee-pages.png)

即可在书写 markdown 博客时通过链接格式`http://username.gitee.io/gitee_pages_repo_name/path_to_the_image`引用这张图片，对于我刚刚上传的这张图片，其链接为`https://chua-n.gitee.io/blog-images/avatar.png`。

我直接在这里引用示意一下，书写 markdown 语句`![](https://chua-n.gitee.io/blog-images/avatar.png)`，显示如下![](https://chua-n.gitee.io/blog-images/avatar.png)
