...
![jupyter挂掉](https://chua-n.gitee.io/figure-bed/blog/远程连接使用mayavi渲染三维图——借助jupyter-notebook/jupyter挂掉.png)
...
![jupyter成功使用mayavi](https://chua-n.gitee.io/figure-bed/blog/远程连接使用mayavi渲染三维图——借助jupyter-notebook/jupyter成功使用mayavi.png)
